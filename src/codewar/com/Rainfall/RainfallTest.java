...
class RainfallTest {
	...
	public static String[] towns = new String[] { "Rome", "London", "Paris", "NY", "Vancouver", "Sydney", "Bangkok",
	...
	@Test
	public void testLondonMean() {
		assertFuzzyEquals(Rainfall.mean("London", RainfallTest.data), 51.199999999999996);
	}
	
	@Test
	public void testLonMean() {
		assertFuzzyEquals(Rainfall.mean("Lon", RainfallTest.data), -1);
	}
	
	@Test
	public void testBeijingMean() {
		assertFuzzyEquals(Rainfall.mean("Beijing", RainfallTest.data), 52.416666666666664);
	}
	
	@Test
	public void testLondonVariance() {
		assertFuzzyEquals(Rainfall.variance("London", RainfallTest.data), 57.42833333333374);
	}
	
	@Test
	public void testBeijingVariance() {
		assertFuzzyEquals(Rainfall.variance("Beijing", RainfallTest.data), 4808.37138888889);
	}
	
	@Test
    public void basicTests(){     
        assertEquals(3,Rainfall.solve("ultrarevolutionariees"));
        assertEquals(2,Rainfall.solve("codewarriors"));
        assertEquals(3,Rainfall.solve("suoidea"));
        assertEquals(1,Rainfall.solve("strengthlessnesses"));
        assertEquals(11,Rainfall.solve("mnopqriouaeiopqrstuvwxyuaeiouaeiou"));
    }
